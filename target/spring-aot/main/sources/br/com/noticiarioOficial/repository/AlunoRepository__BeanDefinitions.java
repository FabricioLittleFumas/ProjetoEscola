...
/**
 * Bean definitions for {@link AlunoRepository}.
 */
@Generated
public class AlunoRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'alunoRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getAlunoRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'alunoRepository'.
   */
  public static BeanDefinition getAlunoRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, AlunoRepository.class, Aluno.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "br.com.noticiarioOficial.repository.AlunoRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.AlunoRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new br.com.noticiarioOficial.repository.AlunoRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getAlunoRepositoryInstanceSupplier();
